...
**2.1 许可性质**  
本软件受著作权法、中国和国际版权条约及其他相关法律法规的保护。我们在此授予您一项非独占、不可转让、不可再许可、可撤销的有限使用权，以用于您的个人或内部业务需求。

**2.2 免费使用权**  
在不违反本协议其他条款的前提下，用户可以免费下载并免费使用本软件，用于非商业目的的内部业务需求。若您需要将本软件或其功能用于商业用途，请事先与我们协商并取得明确的书面授权或签订相应商业合作协议。
...
4.1 Users shall comply with applicable laws, regulations, and this agreement while using the Software and shall not engage in illegal activities using the Software.  
