...
4. 你的账号​
    ...
    4.1 大头与你账号（“统一账号服务”）是指你依据大头与你运营的关联版本产品（包括问表哥 等）的用户协议创建的，供你登录并以注册用户身份使用关联版本产品及服务的凭证。​
    统一账号服务是指，我们（杭州大头与你科技有限公司）通过多个在功能上紧密相连的关联版本产品向你提供服务所使用的统一账号服务。此类关联版本包括问表哥等。为保证一致的服务体验，并保障关联版本之间的互联互通，这些关联版本使用大头与你的统一账号服务，共同收集和处理你的账号信息（例如，昵称和 ID）。你注册、登录 问表哥 的账号也将成为使用统一账号服务的通用标识，允许你同步登录、使用关联版本产品、访问相关服务。​
    ...
    你可以在不登录或注册账号时使用 问表哥，但无法体验 问表哥 的全部功能。​
    ...
    4.11 如果我们认为，你未能遵守本协议的任何规定，或可能会对本服务造成损害，或侵犯任何第三方的权利，或违反任何适用的法律或法规，我们保留随时禁用你的账号、删除你创建的聊天机器人（Bot）以及/或阻止在第三方平台上分发或发布你创建的聊天机器人（Bot）的权利。 为维护良好的平台生态，我们可能会对关联版本产品采取协同的管理手段。例如：如你在问表哥中因违反法律法规或本协议约定的行为被采取处罚措施，你对关联版本及相关服务的使用也可能受到处罚措施的影响，反之亦然。​
​
5. 你使用本服务​
